...
UPDATE:
2025-02-18: TR 
    - updated API URL and calls to v3.0 - changenotes https://pyrat.uniklinik-bonn.de/pyrat/frontend/help/api_v3/en?sessionid=6U2PUtxlzEv6
    - added 'datesacrificed' to the list of requested parameters (previous change)
    - new request URL: url = 'https://pyrat.uniklinik-bonn.de/pyrat/api/v3/‘
    - new request key: ‘k’ instead of ‘_key’) 
"""
...
# url = 'https://pyrat.uniklinik-bonn.de/pyrat/api/v3/'
url = 'https://pyrat.ukbonn.de/pyrat/api/v3/'
...
class PyratIngestion:
    ...
    def ingest_animal(self, SubjectID: str, prompt=True):
        ...
        """
        requested_params = {'k': ['eartag_or_id', 'labid', 'sex', 'dateborn', 'datesacrificed', #TR: added 'datesacrificed',
        ...
        if not payload: # If no entries, exit
            ...
            requested_params = {'k': ['eartag_or_id', 'labid', 'sex', 'dateborn', 'datesacrificed',
                                'strain_id', 'strain_name', 'mutations',
                                'generation', 'parents', 'licence_number',
                                'licence_title', 'owner_fullname',
                                'responsible_fullname'],
    ...
    def strain_status(self, strain_id: str):
        ...
        """
        requested_params = {'k': ['id', 'active'], 'id': strain_id}
